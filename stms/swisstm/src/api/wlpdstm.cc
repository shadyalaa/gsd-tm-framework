...
uint8_t wlpdstm_read_8(uint8_t *address) {
    return read8aligned(wlpdstm::CurrentTransaction::Get(), address);
}

uint16_t wlpdstm_read_16(uint16_t *address) {
    return read16aligned(wlpdstm::CurrentTransaction::Get(), address);
}
...
void wlpdstm_write_8(uint8_t *address, uint8_t value) {
    write8aligned(wlpdstm::CurrentTransaction::Get(), address, value);
}

void wlpdstm_write_16(uint16_t *address, uint16_t value) {
    write16aligned(wlpdstm::CurrentTransaction::Get(), address, value);
}
