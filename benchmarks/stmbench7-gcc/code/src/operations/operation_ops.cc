...
__attribute__((transaction_safe)) int sb7::Operation6::run() const {
...
__attribute__((transaction_safe)) int sb7::Operation7::run() const {
...
__attribute__((transaction_safe)) int sb7::Operation8::run() const {
	// Generate one random number that is in range of possible base assembly
	// identifiers. It is used to look up base assembly from index.
