...
__attribute__((transaction_safe)) int sb7::Traversal1::run() const {
...
__attribute__((transaction_safe)) int sb7::Traversal1::traverse(sh_ptr<ComplexAssembly> sh_cassm) const {
	int partsVisited = 0;
...
__attribute__((transaction_safe)) int sb7::Traversal1::traverse(sh_ptr<BaseAssembly> bassm) const {
	int partsVisited = 0;
...
__attribute__((transaction_safe)) int sb7::Traversal1::traverse(sh_ptr<CompositePart> cpart) const {
...
__attribute__((transaction_safe)) int sb7::Traversal1::traverse(sh_ptr<AtomicPart> apart,
...
__attribute__((transaction_safe)) int sb7::Traversal1::performOperationOnAtomicPart(sh_ptr<AtomicPart> apart,
		Set<sh_ptr<AtomicPart> > &visitedPartSet) const {
	rd_ptr<AtomicPart> rd_apart(apart);
...
__attribute__((transaction_safe)) int sb7::Traversal2a::performOperationOnAtomicPart(sh_ptr<AtomicPart> apart,
		Set<sh_ptr<AtomicPart> > &visitedPartSet) const {
	int ret;
...
__attribute__((transaction_safe)) int sb7::Traversal2b::performOperationOnAtomicPart(sh_ptr<AtomicPart> apart,
		Set<sh_ptr<AtomicPart> > &visitedPartSet) const {
	wr_ptr<AtomicPart> wr_apart(apart);
	wr_apart->swapXY();
	return 1;
...
__attribute__((transaction_safe)) int sb7::Traversal2c::performOperationOnAtomicPart(sh_ptr<AtomicPart> apart,
		Set<sh_ptr<AtomicPart> > &visitedPartSet) const {
	wr_ptr<AtomicPart> wr_apart(apart);
...
__attribute__((transaction_safe)) int sb7::Traversal3a::performOperationOnAtomicPart(sh_ptr<AtomicPart> apart,
		Set<sh_ptr<AtomicPart> > &visitedPartSet) const {
	int ret;
...
__attribute__((transaction_safe)) void sb7::Traversal3a::updateBuildDate(sh_ptr<AtomicPart> apart) const {
...
__attribute__((transaction_safe)) int sb7::Traversal3b::performOperationOnAtomicPart(sh_ptr<AtomicPart> apart,
		Set<sh_ptr<AtomicPart> > &visitedPartSet) const {
	updateBuildDate(apart);
	return 1;
}
...
__attribute__((transaction_safe)) int sb7::Traversal3c::performOperationOnAtomicPart(sh_ptr<AtomicPart> apart,
		Set<sh_ptr<AtomicPart> > &visitedPartSet) const {
	updateBuildDate(apart);
	updateBuildDate(apart);
	updateBuildDate(apart);
...
__attribute__((transaction_safe)) int sb7::Traversal4::traverse(sh_ptr<CompositePart> cpart) const {
	rd_ptr<CompositePart> rd_cpart(cpart);
	return traverse(rd_cpart->getDocumentation());
}

__attribute__((transaction_safe)) int sb7::Traversal4::traverse(sh_ptr<Document> doc) const {
	rd_ptr<Document> rd_doc(doc);
	return rd_doc->searchText('I');
}

__attribute__((transaction_safe)) int sb7::Traversal4::traverse(sh_ptr<AtomicPart> part,
		Set<sh_ptr<AtomicPart> > &setOfVisitedParts) const {
	throw Sb7Exception("T4: traverse(AtomicPart, HashSet<AtomicPart>) called!");
}

__attribute__((transaction_safe)) int sb7::Traversal4::performOperationOnAtomicPart(sh_ptr<AtomicPart> apart,
...
__attribute__((transaction_safe)) int sb7::Traversal5::traverse(sh_ptr<Document> doc) const {
	int ret;
...
__attribute__((transaction_safe)) int sb7::Traversal6::traverse(sh_ptr<CompositePart> cpart) const {
	rd_ptr<CompositePart> rd_cpart(cpart);
...
__attribute__((transaction_safe)) int sb7::Traversal7::run() const {
...
__attribute__((transaction_safe)) int sb7::Traversal7::traverse(sh_ptr<CompositePart> cpart) const {
...
__attribute__((transaction_safe)) int sb7::Traversal7::traverse(sh_ptr<Assembly> assembly,
...
__attribute__((transaction_safe)) void sb7::Traversal7::performOperationOnAssembly(
...
__attribute__((transaction_safe)) int sb7::Traversal8::run() const {
	rd_ptr<Module> rd_mod(dataHolder->getModule());
	return traverse(rd_mod->getManual());
}

__attribute__((transaction_safe)) int sb7::Traversal8::traverse(sh_ptr<Manual> manual) const {
...
__attribute__((transaction_safe)) int sb7::Traversal9::traverse(sh_ptr<Manual> manual) const {
	rd_ptr<Manual> rd_manual(manual);
