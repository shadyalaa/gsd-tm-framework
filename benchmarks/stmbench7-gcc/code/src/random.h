...
namespace sb7 {
	...
	public:
		...
		__attribute__((transaction_pure)) int nextInt();
		
		__attribute__((transaction_pure)) int nextInt(int n);
		
		__attribute__((transaction_pure)) double nextDouble();
...
__attribute__((transaction_pure)) inline sb7::Random *sb7::get_random() {
