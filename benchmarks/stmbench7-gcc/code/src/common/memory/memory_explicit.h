...
namespace sb7 {
	...
	// too.
	__attribute__((transaction_pure)) void *tx_malloc(size_t size);
	__attribute__((transaction_pure)) void tx_free(Alloced *);
...
__attribute__((transaction_pure)) inline void sb7::mem_tx_start() {
	mem_tx_start(NULL);
}
