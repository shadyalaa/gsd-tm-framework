...
# define FAST_PATH_RESTART() (*abortFunPtr)(Self);
# define FAST_PATH_SHARED_READ(var) (*sharedReadFunPtr)(Self, (vintp*)(void*)&(var))
# define FAST_PATH_SHARED_READ_P(var) IP2VP(FAST_PATH_SHARED_READ(var))
# define FAST_PATH_SHARED_READ_D(var) IP2D((*sharedReadFunPtr)(Self, (vintp*)DP2IPP(&(var))))
# define FAST_PATH_SHARED_WRITE(var, val) (*sharedWriteFunPtr)(Self, (vintp*)(void*)&(var), (intptr_t)val)
# define FAST_PATH_SHARED_WRITE_P(var, val) (*sharedWriteFunPtr)(Self, (vintp*)(void*)&(var), VP2IP(val))
# define FAST_PATH_SHARED_WRITE_D(var, val) (*sharedWriteFunPtr)(Self, (vintp*)DP2IPP(&(var)), D2IP(val))
