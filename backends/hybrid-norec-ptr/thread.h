...
extern void abortHTM(norec_Thread* norec_Self);
extern intptr_t sharedReadHTM(norec_Thread* norec_Self, intptr_t* addr);
extern void sharedWriteHTM(norec_Thread* norec_Self, intptr_t* addr, intptr_t val);
extern void freeSTM(void* ptr);
extern void abortSTM(norec_Thread* norec_Self);
extern intptr_t sharedReadSTM(norec_Thread* norec_Self, intptr_t* addr);
extern void sharedWriteSTM(norec_Thread* norec_Self, intptr_t* addr, intptr_t val);

extern __thread void (*freeFunPtr)(void* ptr);
extern __thread void (*abortFunPtr)(norec_Thread* norec_Self);
extern __thread intptr_t (*sharedReadFunPtr)(norec_Thread* norec_Self, intptr_t* addr);
extern __thread void (*sharedWriteFunPtr)(norec_Thread* norec_Self, intptr_t* addr, intptr_t val);
